app.controller("studentTestTakenController",["$scope","$document","$http","$location","$rootScope",function($scope,$document,$http,$location,$rootScope){
  ...
  var pregunta7={
    texto:"Las islas. espacio en blanco. se encuentran en la región insular del Ecuador",
    id:"a7",
    tipo:"completarSeleccionando",
    respuestas:[
      {
...
$scope.preguntas=[
  pregunta, pregunta2, pregunta3, pregunta4, pregunta7, pregunta6
];
...
{
// if it errors, this clears out the error.
...
$rootScope.msg.text = sentences[i];
$rootScope.synth.speak($rootScope.msg);

  ...
  register: function(req, res) {
    ...
    .exec(function(error, newRecord) {
      if (error) {
        ...
        sails.models.usrcou.query(
          'INSERT INTO USR_COU (EMAIL, IDCOURSE, STATUSUSRCOU) VALUES (?,?,?)', [email, newRecord.id, status],
    ...
    registerStudent: function(req, res) {
      ...
      if (req.body.student.email) {
        ...
        return res.json(400, {
          msg: "There is not a student's email send"
        });
      }
      if (req.body.course.id) {
        ...
        var idCourse = null;
        return res.json(400, {
          msg: "There is not a course's id send"
        });
      }
      ...
      if (req.body.user.email) {
        ...
        var idCourse = null;
        return res.json(400, {
          msg: "There is not a user's email send"
        });
      }
      ...
      sails.models.usrcou.findOne({
        ...
        if (err) {
          ...
          if (teacher) {
            ...
            sails.models.user.query("SELECT * FROM USR_ROL WHERE EMAIL=? AND NAME='student' ", [studentEmail], function(error, results) {
              if (error) {
                ...
                if (results[0]) {
                  ...
                  return res.json(201, {
                    msg: "There is not an student with that email"
                  });
                }
              }
            });
            ...
            return res.json(400, {
              msg: "The user is not the owner of the course"
            });
          }
        }
      });
    ...
    clone: function(req, res) {
      ...
      if (!req.body.user) {
        ...
        return res.json(400, {
          msg: "Error cloning the course, no user send"
        });
      }
      if (!req.body.course) {
        return res.json(400, {
          msg: "Error cloning the course, no course send"
        });
      }
      if (req.body.course.id) {
        var courseId = req.body.course.id;
        ...
        return res.json(400, {
          msg: "Error cloning the course, no course id send"
        });
      }
      if (req.body.user.email) {
        var email = req.body.user.email;
        ...
        return res.json(400, {
          msg: "Error cloning the course, no email send"
        });
      }
      ...
      .then(function(finded) {
        if (finded) {
                        ...
                        .then(function() {
                          ...
                          .then(function() {
                            if (responseSend == false) {
                              responseSend = true;
                              return res.json(200, {
                                msg: "Course cloned successfully"
                              });
                            }
                          })
                          .catch(function(error) {
          ...
          if (responseSend == false) {
            responseSend = true;
            return res.json(400, {
              msg: "Error cloning the course, the user is not the owner of the course"
            });
          }
        }
      })
    ...
    deleteStudent: function(req, res) {
      if (req.body.studentEmail) {
        ...
        return res.json(400, {
          msg: "Error deleting the user, no student email send"
        });
      }
      if (req.body.teacherEmail) {
        ...
        return res.json(400, {
          msg: "Error deleting the user, no teacher email send"
        });
      }
      if (req.body.idCourse) {
        ...
        return res.json(400, {
          msg: "Error deleting the user, no course send"
        });
      }
      var promises = [];
